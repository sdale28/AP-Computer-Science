 ...
 *        Also, fill the student.dat file with about 20 students. The goal is to implement a binary search.
 *
 * java StudentDriver
 */
...
public class StudentDriver
{
    ...
    public static int findStudent(ArrayList <Student> students, Scanner scan,String print)
    {
        ...
        else
        {
            ...
            int modifyIndex=DriverUtil.binarySearch(students,modifyId); //Implements binary search for student to modify.
            if (modifyIndex!=-1)
                return modifyIndex;
