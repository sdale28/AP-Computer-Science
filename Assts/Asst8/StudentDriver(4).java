 ...
 * Asst8: Binary Search. In the findStudent method, use a binary search to find the student of the desired ID number (in order to speed the search process). 
 *        Also, fill the student.dat file with about 20 students. 
 */
import java.util.*;
import java.io.*;
